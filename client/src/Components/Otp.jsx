    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-100">
      ...
      <div>
        ...
        <div className="flex flex-col justify-center p-8 md:p-14">
          ...
          <span>Enter the verification code we just sent to your mobile number</span>
          ...
          <Link to='/idverify'><button className="bg-orange-300 mt-9 rounded-md p-3 w-96">Verify</button></Link>
